...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1520 900" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <text x="844" y="189.5" font-size="8.5" fill="#475569">topK_ep_table：从 Core Mem 载入的 topK，每 stream ≤ 256 B</text>
  ...
  <text x="262" y="634.5" font-size="8.5" fill="#475569">算力：BF17×BF17 4K MACs · MXFP8×MXFP8 8K MACs（scale block 32，E8M0）</text>
  <text x="262" y="648.0" font-size="8.5" fill="#475569">　　　MXFP8×MXFP4 与 MXFP8×NVFP4 各 16K MACs（scale block 16，FP8）· BF17×MXFP4 与 BF17×NVFP4 各 8K MACs</text>
  <text x="262" y="661.5" font-size="8.5" fill="#475569">八种计算原语：MXFP8 的 1×K128×N64 与 1×K64×N128；BF17 的 1×K64×N64 与 1×K32×N128；</text>
  ...
  <text x="262" y="715.5" font-size="8.5" fill="#475569">数据类型：token(A) / weight(B) 输入 BF17 或 MXFP8；W_ep 输入 FP32；输出 FP32 或 BF17</text>
...
| F29 | 算力按精度组合分六档：BF17×BF17 4K MACs；MXFP8×MXFP8 8K MACs（scale block 32，E8M0）；MXFP8×MXFP4 与 MXFP8×NVFP4 各 16K MACs（scale block 16，FP8）；BF17×MXFP4 与 BF17×NVFP4 各 8K MACs |
| F30 | 八种计算原语：MXFP8 的 `1×K128×N64` 与 `1×K64×N128`；BF17 的 `1×K64×N64` 与 `1×K32×N128`；W4A8 的 `1×K256×N64` 与 `1×K128×N128`；W4A16 的 `1×K128×N64` 与 `1×K64×N128` |
| F31 | 数据类型：token(A) 与 weight(B) 输入 BF17 或 MXFP8，`W_ep` 输入 FP32，输出 FP32 或 BF17 |
...
| F37 | 性能目标：MXFP8 下 Primitive K256×N32 和 K128×N64 阵列利用率 100%，BF17 与 MXFP4 同样 100%；Primitive `1×64×128` 且 K=64 时有 50% 性能损失；Tile K×N 过小会有性能损失，由 RV core 配置延时和 MU 内启动延时决定 |
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 844 522" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="300" y1="98" x2="314" y2="98" stroke="#475569" marker-end="url(#aruov)"/>
  ...
  <line x1="466" y1="98" x2="480" y2="98" stroke="#475569" marker-end="url(#aruov)"/>
  ...
  <line x1="632" y1="98" x2="646" y2="98" stroke="#475569" marker-end="url(#aruov)"/>
  ...
  <line x1="300" y1="184" x2="314" y2="184" stroke="#475569" marker-end="url(#aruov)"/>
  ...
  <line x1="300" y1="356" x2="314" y2="356" stroke="#475569" marker-end="url(#aruov)"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 938 244" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="58" x2="228" y2="58" stroke="#475569" marker-end="url(#aru1)"/>
  <line x1="188" y1="139" x2="228" y2="139" stroke="#475569" marker-end="url(#aru1)"/>
  <line x1="698" y1="122" x2="738" y2="122" stroke="#475569" marker-end="url(#aru1)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 819 198" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="99" x2="228" y2="99" stroke="#475569" marker-end="url(#aru2)"/>
  <line x1="579" y1="99" x2="619" y2="99" stroke="#475569" marker-end="url(#aru2)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 845 218" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="55" x2="228" y2="55" stroke="#475569" marker-end="url(#aru3)"/>
  <line x1="188" y1="123" x2="228" y2="123" stroke="#475569" marker-end="url(#aru3)"/>
  <line x1="188" y1="177" x2="228" y2="177" stroke="#475569" marker-end="url(#aru3)"/>
  <line x1="605" y1="109" x2="645" y2="109" stroke="#475569" marker-end="url(#aru3)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 893 198" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="72" x2="228" y2="72" stroke="#475569" marker-end="url(#aru4)"/>
  <line x1="188" y1="140" x2="228" y2="140" stroke="#475569" marker-end="url(#aru4)"/>
  <line x1="653" y1="72" x2="693" y2="72" stroke="#475569" marker-end="url(#aru4)"/>
  <line x1="653" y1="126" x2="693" y2="126" stroke="#475569" marker-end="url(#aru4)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 884 200" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="73" x2="228" y2="73" stroke="#475569" marker-end="url(#aru5)"/>
  <line x1="188" y1="127" x2="228" y2="127" stroke="#475569" marker-end="url(#aru5)"/>
  <line x1="644" y1="58" x2="684" y2="58" stroke="#475569" marker-end="url(#aru5)"/>
  <line x1="644" y1="143" x2="684" y2="143" stroke="#475569" marker-end="url(#aru5)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 853 200" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="73" x2="228" y2="73" stroke="#475569" marker-end="url(#aru6)"/>
  <line x1="188" y1="127" x2="228" y2="127" stroke="#475569" marker-end="url(#aru6)"/>
  <line x1="613" y1="58" x2="653" y2="58" stroke="#475569" marker-end="url(#aru6)"/>
  <line x1="613" y1="143" x2="653" y2="143" stroke="#475569" marker-end="url(#aru6)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 883 246" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <text x="775" y="128" font-size="10" fill="#334155" text-anchor="middle">d[lane] FP32/BF17</text>
  ...
  <line x1="188" y1="55" x2="228" y2="55" stroke="#475569" marker-end="url(#aru7)"/>
  <line x1="188" y1="137" x2="228" y2="137" stroke="#475569" marker-end="url(#aru7)"/>
  <line x1="188" y1="205" x2="228" y2="205" stroke="#475569" marker-end="url(#aru7)"/>
  <line x1="643" y1="123" x2="683" y2="123" stroke="#475569" marker-end="url(#aru7)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 899 198" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <text x="104" y="77" font-size="10" fill="#334155" text-anchor="middle">d[lane] FP32/BF17</text>
  ...
  <line x1="188" y1="72" x2="228" y2="72" stroke="#475569" marker-end="url(#aru8)"/>
  <line x1="188" y1="140" x2="228" y2="140" stroke="#475569" marker-end="url(#aru8)"/>
  <line x1="659" y1="99" x2="699" y2="99" stroke="#475569" marker-end="url(#aru8)"/>
</svg>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 917 198" font-family="PingFang SC, Noto Sans CJK SC, Microsoft YaHei, sans-serif">
  ...
  <line x1="188" y1="72" x2="228" y2="72" stroke="#475569" marker-end="url(#aru9)"/>
  <line x1="188" y1="125" x2="228" y2="125" stroke="#475569" marker-end="url(#aru9)"/>
  <line x1="677" y1="62" x2="717" y2="62" stroke="#475569" marker-end="url(#aru9)"/>
  <line x1="677" y1="141" x2="717" y2="141" stroke="#475569" marker-end="url(#aru9)"/>
</svg>
```
...
算力               BF17 4K · MXFP8 8K · W4A8 16K · W4A16 8K MAC/T
issue_q            16
